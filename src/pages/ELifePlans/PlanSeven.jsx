...
const PlanSeven = ({handleCallbackButtonClick}) => {
    ...
    <div className="elife_container">
      ...
      >
        <div className="elife_title">
          ...
          <h4 className="sub">Unlimited Entertainment</h4>
        </div>
        ...
        <section className="section_device">
          ...
          <p className="para_content_channel">
            Premium Entertainment & OSN Channels
          </p>
        ...
        <section className="section_device" style={{ visibility: "hidden" }}>
