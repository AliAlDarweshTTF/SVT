...
const PlanSix = ({handleCallbackButtonClick}) => {
    ...
    <div className="elife_container">
      ...
      >
        <div className="elife_title">
          ...
          <h4 className="sub">Unlimited Sports</h4>
        </div>
        ...
        <section className="section_device">
          ...
          <p className="para_content_channel">Sports & Entertainment</p>
          <div className="channels" style={{ visibility: "hidden" }}>
